...
function bootstrap_scripts()
{
    ...
    wp_register_script( 'wookmark', get_template_directory_uri() . '/js/jquery.wookmark.js', array( 'jquery' ) );
...
function bootstrap_styles()
{
	...
	wp_register_style( 'bootstrap-styles', get_template_directory_uri() . '/css/bootstrap.css', array(), '2.3.0', 'all' );
    wp_register_style( 'font-awesome', get_template_directory_uri() . '/css/font-awesome.css', array(), '3.0', 'all' );
	wp_register_style( 'colorbox', get_template_directory_uri() . '/css/colorbox.css', array(), '1.3.19', 'all' );
    wp_register_style( 'responsive-style', get_template_directory_uri(). '/style.css', false, '1.2.0', 'all' );
